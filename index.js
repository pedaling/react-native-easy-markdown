...
class Markdown extends Component {
  ...
  constructor(props) {
    ...
    const defaultStyles = this.props.useDefaultStyles && styles
      ? styles
      : {};
...
*/
  ...
  renderNode(node, key, index, extras) {
    ...
    switch (node.type) {
      ...
      case 'strong':
        return this.renderText(node, key, Utils.concatStyles(extras, styles.strong));
      case 'del':
        return this.renderText(node, key, Utils.concatStyles(extras, styles.del));
      case 'em':
